...
namespace BasketballTickets.Controllers
{
    ...
    {
        public GameTypesController(ApplicationDbContext context) : base(context)
        {
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] GameType gameType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] GameType gameType)
        {
            if (id != gameType.Id)
            {
                return NotFound();
